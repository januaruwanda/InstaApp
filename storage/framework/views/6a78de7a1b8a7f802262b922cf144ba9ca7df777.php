        ...
        <div class="w3-row">
            ...
            <div class="w3-col m7">
                ...
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    ...
                    <span class="w3-right w3-opacity"><?php echo e($p->created_at->diffForHumans()); ?></span>
                    <h4><?php echo e($p->name); ?></h4><br>
                    <hr class="w3-clear">
                    <p><?php echo e($p->caption); ?></p>
                    <div class="w3-row-padding" style="margin:0 -16px">
                        <div class="w3-half">
                            <img src="<?php echo e(asset('images/'.$p->gambar)); ?>" style="width:100%" alt="Nature" class="w3-margin-bottom">
                        </div>
                    </div>
                    ...
                    <button class="w3-button w3-theme-d2 w3-margin-bottom" type="button" data-bs-toggle="collapse" data-bs-target="#view-comments-<?php echo e($p->id); ?>" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div class="w3-container w3-card w3-white w3-round w3-margin panel-footer clearfix">
                    ...
                    <div id="view-comments-<?php echo e($p->id); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\instaApp\resources\views/index.blade.php ENDPATH**/ ?>